# Large-Scale GA
### A genetic algorithm developed for problems with discrete representation.
...
DISCLAIMER: These operators were developed **ONLY** for **discrete solution representations**!
